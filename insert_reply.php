...
include './database.php';
  ...
  $stmt = $conn->prepare("INSERT INTO reply (list_id,author,content) VALUES ('$board_id', '$author', '$content')");
  /* Query 실행 */
  $stmt->execute();
  ?>
 ...
 <html>
   ...
   <body>
       ...
       <h1 class="top1"><strong>댓글이 성공적으로 등록되었습니다.</strong></h1>
       <br><br><br>
       <hr id="hr1">
      <a href="./listin.php?id=<?php echo $board_id?>"></a> <button type="button" class="btn btn-default listinbtn" onclick="location.href='./list.php'">목록으로 돌아가기</button>
